...
VALUES 	('Phong 1'), ('Phong 2'), ('Phong 3'), ('Phong 4'), ('Phong 5'), ('Phong 6'), ('Phong 7'), ('Phong 8'), ('Phong 9'), ('Phong 10');

INSERT INTO `Position` (PositionName)
VALUES  ('Dev'), ('Test'), ('Scrum Master'), ('PM'), ('Dev'), ('Test'), ('Scrum Master'), ('PM'), ('Dev'), ('Test');
...
VALUES 	('Essay'), ('Multiple-Choice'), ('Multiple-Choice'), ('Multiple-Choice'), ('Essay'), ('Essay'), ('Multiple-Choice'), ('Essay'), ('Multiple-Choice'), ('Essay');

INSERT INTO `CategoryQuestion` (CategoryName)
VALUES ('Java'), ('.NET'), ('SQL'), ('Postman'), ('Ruby'), ('Java'), ('.NET'), ('SQL'), ('Postman'), ('Ruby');
